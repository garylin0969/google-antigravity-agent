...
#### 📦 來自 [vercel-labs/next-skills](https://github.com/vercel-labs/next-skills)

安裝指令：`npx skills add vercel-labs/next-skills`

| 資料夾                                  | 說明                                                                   |
| :-------------------------------------- | :--------------------------------------------------------------------- |
| `.claude/skills/next-best-practices/`   | Next.js 核心知識：檔案規範、RSC 邊界、資料模式、Async API、錯誤處理等  |
| `.claude/skills/next-cache-components/` | Next.js 16 Cache Components：PPR、`use cache`、`cacheLife`、`cacheTag` |

#### 📦 來自 [vercel-labs/agent-skills](https://github.com/vercel-labs/agent-skills)

安裝指令：`npx skills add vercel-labs/agent-skills`

| 資料夾                                        | 說明                                                          |
| :-------------------------------------------- | :------------------------------------------------------------ |
| `.claude/skills/vercel-react-best-practices/` | Vercel 官方 React & Next.js 效能最佳化指南，涵蓋 40+ 規則     |
| `.claude/skills/vercel-composition-patterns/` | React 組合模式：Compound Components、狀態提升、避免 prop 膨脹 |
| `.claude/skills/web-design-guidelines/`       | UI 審查：無障礙、效能、UX 等 100+ 規則                        |

#### 📦 來自 [shadcn/ui](https://ui.shadcn.com/docs/skills)

安裝指令：`pnpm dlx skills add shadcn/ui`

| 資料夾                   | 說明                                                             |
| :----------------------- | :--------------------------------------------------------------- |
| `.claude/skills/shadcn/` | shadcn/ui 元件知識、CLI 指令、Theming、Registry、MCP Server 整合 |
...
└── skills/                                        # 🧰 技能目錄（英文版，VS Code + Claude Code 皆可讀取）
    ...
    │
    │  # 📦 來自 vercel-labs/next-skills
    ├── next-best-practices/
    │   └── SKILL.md                               # Next.js 核心知識
    ├── next-cache-components/
    │   └── SKILL.md                               # Next.js 16 Cache Components
    │
    │  # 📦 來自 vercel-labs/agent-skills
    ├── vercel-react-best-practices/
    │   └── SKILL.md                               # React & Next.js 效能最佳化指南
    ├── vercel-composition-patterns/
    │   └── SKILL.md                               # React 組合模式
    ├── web-design-guidelines/
    │   └── SKILL.md                               # UI 審查：無障礙、效能、UX
    │
    │  # 📦 來自 shadcn/ui
    └── shadcn/
        └── SKILL.md                               # shadcn/ui 元件、CLI、Theming

中文版/
└── skills/                                        # 🧰 技能目錄（繁體中文版，僅自行撰寫部分）
    ├── component-structure/
    │   └── SKILL.md
    ├── file-naming-convention/
    │   └── SKILL.md
